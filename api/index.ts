...
Forneça a sua resposta estritamente estruturada em formato JSON válido contendo uma lista sob a chave "beats". Cada item da lista deve conter "pageNumber" and "description". Adicionalmente, forneça um breve campo "summary" descrevendo sua lógica de divisão orquestrada.`;
